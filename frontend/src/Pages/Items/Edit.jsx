...
const dummyItem = { id: 1, code: 'BRG001', name: 'Laptop ASUS ROG', category_id: 1, supplier_id: 1, stock: 50, min_stock: 10, unit: 'pcs', description: 'Laptop gaming' };
...
export default function Edit() {
    ...
    const [data, setData] = useState({
        code: dummyItem.code,
        name: dummyItem.name,
        category_id: dummyItem.category_id,
        supplier_id: dummyItem.supplier_id,
        stock: dummyItem.stock,
        min_stock: dummyItem.min_stock,
        unit: dummyItem.unit,

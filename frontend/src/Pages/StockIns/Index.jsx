...
const dummyStockIns = {
    data: [
        { id: 1, item: { name: 'Laptop ASUS ROG' }, quantity: 5, user: { name: 'Admin' }, description: 'Restock', created_at: new Date().toISOString() },
        { id: 2, item: { name: 'Mouse Logitech' }, quantity: 20, user: { name: 'Admin' }, description: '', created_at: new Date(Date.now() - 86400000).toISOString() },
    ],
    total: 2,
    from: 1,
    last_page: 1,
    links: [
        ...
        { label: '1', url: '/stock-ins?page=1', active: true },
                ...
                <div style={{ 
                    ...
                    <div>
                        ...
                        <p style={{ margin: 0, fontSize: '14px', color: '#64748b' }}>
                            Total {dummyStockIns.total} transaksi masuk tercatat
                        </p>
                    </div>
                    <Link
                        to="/stock-ins/create"
                ...
                <div style={{ 
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
                        ...
                        <tbody style={{ color: '#1e293b' }}>
                            {dummyStockIns.data.length === 0 ? (
                                ...
                                dummyStockIns.data.map((s, i) => {
                                    return (
                                        <tr key={s.id} style={{ borderBottom: i === dummyStockIns.data.length - 1 ? 'none' : '1px solid #f1f5f9' }}>
                    ...
                    {dummyStockIns.last_page > 1 && (
                        <div style={{
                            ...
                            {dummyStockIns.links.map((link, i) => (
                                <Link
                                    key={i}
                                    to={link.url ?? '#'}
                                    style={{

...
export default function ResetPassword() {
    const [data, setData] = useState({ email: '', password: '', password_confirmation: '' });
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                    ...
                    <h2 style={{ color: 'white', fontSize: '24px', fontWeight: 800 }}>Reset Password</h2>
                    <p style={{ color: '#94a3b8', fontSize: '14px', marginTop: '4px' }}>Masukkan password baru Anda</p>
                </div>
                ...
                <form onSubmit={submit}>
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        <label style={{ display: 'block', color: '#e2e8f0', fontSize: '14px', fontWeight: 600, marginBottom: '8px' }}>Password Baru</label>
                        <input
                            type="password"
                            value={data.password}
                    ...
                    <div style={{ marginBottom: '28px' }}>
                        <label style={{ display: 'block', color: '#e2e8f0', fontSize: '14px', fontWeight: 600, marginBottom: '8px' }}>Konfirmasi Password</label>
                        <input
                            type="password"

...
export default function AuthenticatedLayout({ header, children }) {
    ...
    // Baca user dari localStorage (disimpan saat login)
    ...
    return (
        <div className="min-h-screen flex" style={{ fontFamily: "'Segoe UI', sans-serif" }}>
            ...
            >
                {/* Logo */}
                <div className="flex items-center gap-3" style={{ padding: '16px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                        ...
                        {sidebarOpen ? (
                            <div className="flex items-center gap-3">
                                <div style={{
                                    ...
                                    color: '#0ea5e9', display: 'flex', alignItems: 'center',
                                    justifyContent: 'center', fontSize: '13px', fontWeight: '700',
                                }}>
                                    {auth.name?.charAt(0).toUpperCase()}
                                </div>
                                <div className="flex-1 min-w-0">
                                    <p style={{ fontSize: '13px', fontWeight: '700', color: '#ffffff', margin: 0, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{auth.name}</p>
                                    <p style={{ fontSize: '10px', color: '#94a3b8', margin: 0, textTransform: 'capitalize' }}>{auth.role}</p>
                                </div>
                            </div>
                        ) : (
                            <div style={{
                                ...
                                backgroundColor: '#1e293b', border: '1px solid rgba(255,255,255,0.1)',
                                color: '#0ea5e9', display: 'flex', alignItems: 'center',
                                justifyContent: 'center', fontSize: '13px', fontWeight: '700', margin: '0 auto',
                            }}>
                                {auth.name?.charAt(0).toUpperCase()}
                            </div>
                        )}
            ...
            <div className="flex-1 flex flex-col transition-all duration-300"
                ...
                {/* Topbar */}
                <header className="flex items-center justify-between sticky top-0 z-10 px-6"
                    ...
                    <div className="flex items-center gap-4">
                        <Link to="/profile" className="flex items-center gap-2 px-4 py-2 text-sm font-600 text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-lg transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            {showLogoutModal && (
                <div style={{
                    ...
                    <div style={{ backgroundColor: 'white', padding: '28px', borderRadius: '16px', maxWidth: '400px', width: '90%' }}>
                        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                            ...
                            <h3 style={{ fontSize: '20px', fontWeight: '800', color: '#1e293b', marginBottom: '8px' }}>Konfirmasi Logout</h3>
                            <p style={{ fontSize: '14px', color: '#64748b', lineHeight: '1.5' }}>Apakah Anda yakin ingin keluar dari akun ini?</p>
                        </div>
                        <div style={{ display: 'flex', gap: '12px' }}>
                            <button
                                ...
                                style={{
                                    ...
                                    borderRadius: '10px', backgroundColor: 'white', color: '#64748b',
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    borderRadius: '10px', backgroundColor: '#dc2626', color: 'white',
                                    fontSize: '14px', fontWeight: '600', cursor: loggingOut ? 'not-allowed' : 'pointer',
